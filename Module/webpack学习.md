...
这样的工具，叫做**构建工具**
![image.png](./images/webpack学习/1.png)
...
![image.png](./images/webpack学习/2.png)
![image.png](./images/webpack学习/3.png)

### 不同模块化标准

不同的模块化标准，webpack按照如下的方式处理
![image.png](./images/webpack学习/4.png)
![image.png](./images/webpack学习/5.png)
...
![image.png](./images/webpack学习/6.png)
...
![image.png](./images/webpack学习/7.png)
![image.png](./images/webpack学习/8.png)
**最佳实践**：
...
![image.png](./images/webpack学习/9.png)
整个过程大致分为三个步骤
...
![image.png](./images/webpack学习/10.png)
...
![image.png](./images/webpack学习/11.png)
每个chunk都有至少两个属性：
...
![image.png](./images/webpack学习/12.png)

> AST在线测试工具：[https://astexplorer.net/](https://astexplorer.net/)


简图
![image.png](./images/webpack学习/13.png)
...
![image.png](./images/webpack学习/14.png)
...
简图
![image.png](./images/webpack学习/15.png)

4. **合并chunk assets**

将多个chunk的assets合并到一起，并产生一个总的hash
![image.png](./images/webpack学习/16.png)

### 输出

此步骤非常简单，webpack将利用node中的fs模块（文件处理模块），根据编译产生的总的assets，生成相应的文件。
![image.png](./images/webpack学习/17.png)

### 总过程

![image.png](./images/webpack学习/18.png)
![image.png](./images/webpack学习/19.png)
**涉及术语**
...
![image.png](./images/webpack学习/20.png)
...
![image.png](./images/webpack学习/21.png)
源码结构
...
![image.png](./images/webpack学习/22.png)
源码结构
...
![image.png](./images/webpack学习/23.png)
源码结构
...
![image.png](./images/webpack学习/24.png)
loader函数的将在模块语法解析的过程中被调用，以得到最终的源码。

**全流程：**
![image.png](./images/webpack学习/25.png)
**chunk中解析模块的流程：**
![image.png](./images/webpack学习/26.png)
**chunk中解析模块的更详细流程：**
![image.png](./images/webpack学习/27.png)
**处理loaders流程：代码在每一个 loader 函数中进行挨个执行**
![image.png](./images/webpack学习/28.png)
...
![image.png](./images/webpack学习/29.png)
...
![image.png](./images/webpack学习/30.png)
...
![image.png](./images/webpack学习/31.png)
三个部分的具体含义为：
...
![image.png](./images/webpack学习/32.png)
...
![image.png](./images/webpack学习/35.png)
...
![image.png](./images/webpack学习/36.png)
目前，最流行的预编译器有**LESS**和**SASS**，由于它们两者特别相似，因此仅学习一种即可
![image.png](./images/webpack学习/37.png)
...
![image.png](./images/webpack学习/38.png)
看上去是不是和LESS、SASS一样呢？

但PostCss和LESS、SASS的思路不同，它其实只做一些代码分析之类的事情，将分析的结果交给插件，具体的代码转换操作是插件去完成的。
![image.png](./images/webpack学习/39.png)
官方的一张图更能说明postcss的处理流程：
![image.png](./images/webpack学习/40.png)
...
![image.png](./images/webpack学习/41.png)
发生了两处错误：
...
![image.png](./images/webpack学习/42.png)
巴别塔象征的统一的国度、统一的语言
...
本章所讲的性能优化主要体现在三个方面：
![image.png](./images/webpack学习/45.png)
**构建性能**
...
![image.png](./images/webpack学习/46.png)
模块解析包括：抽象语法树分析、依赖分析、模块语法替换

#### 不做模块解析会怎样？

![image.png](./images/webpack学习/47.png)
...
![image.png](./images/webpack学习/48.png)
...
![image.png](./images/webpack学习/49.png)
而使用了热替换后，流程发生了变化
![image.png](./images/webpack学习/50.png)
...
![image.png](./images/webpack学习/51.png)
...
![image.png](./images/webpack学习/52.png)
...
![image.png](./images/webpack学习/53.png)
从分包流程中至少可以看出以下几点：
...
![image.png](./images/webpack学习/54.png)
优点：传输效率可能得到大幅提升
...
![image.png](./images/webpack学习/55.png)
...
![image.png](./images/webpack学习/56.png)
