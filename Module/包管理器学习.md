...
- **文件的本质**
   ...
   - 当我们删除文件时，删除的实际上是指针，因此，无论删除多么大的文件，速度都非常快。![image.png](../public/images/note/包管理器/6.png)
- **文件的拷贝**
...
![image.png](../public/images/note/包管理器/8.png)
...
![image.png](../public/images/note/包管理器/11.png)
...
![image.png](../public/images/note/包管理器/14.png)
